var TradingView = function(t) {
    ...
    var s = function() {
        ...
        t.prototype._autoResizeChart = function() {
            this._options.fullscreen && (this._iFrame.style.height = "100%")
        }
        ,
        t.prototype._create = function() {
            ...
            o.innerHTML = e,
            this._iFrame = o.querySelector("#" + this._id);
            var n = this._iFrame;
            ...
            this._innerWindowLoaded = new Promise((function(t) {
                var e = function() {
                    n.removeEventListener("load", e, !1),
                    t()
                };
        ...
        t.prototype._render = function() {
            ...
            return '<iframe id="' + this._id + '" name="' + this._id + '"  src="' + e + '"' + (this._options.autosize || this._options.fullscreen ? "" : ' width="' + this._options.width + '" height="' + this._options.height + '"') + ' frameborder="0" allowTransparency="true" scrolling="no" allowfullscreen style="height: 100%; margin: 0px !important; padding: 0px !important;"></iframe>'
        }
        ,
        t
    }();
